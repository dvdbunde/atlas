...
namespace ATLAS.Infrastructure.Tests.EventHandlers
{
    public class ApplicationAssignedToOfficerEventHandlerTests
    {
        ...
        public ApplicationAssignedToOfficerEventHandlerTests()
        {
            ...
            _handler = new ApplicationAssignedToOfficerEventHandler(_auditLogRepository, _currentUserService.Object);
        }
        ...
        public async Task Handle_ValidEvent_ShouldPersistToAuditLog()
        {
            ...
            var evt = new ApplicationAssignedToOfficerEvent(applicationId);
        ...
        {
            // Act & Assert
            Assert.Throws<ArgumentNullException>(() => new ApplicationAssignedToOfficerEventHandler(null!, _currentUserService.Object));
        }      
    }
}
