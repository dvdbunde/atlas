...
namespace ATLAS.Infrastructure.Tests.EventHandlers
{
    public class ApplicationApprovedEventHandlerTests
    {
        ...
        public ApplicationApprovedEventHandlerTests()
        {
            ...
            _handler = new ApplicationApprovedEventHandler(_auditLogRepository);
        }
        ...
        public async Task Handle_ValidEvent_ShouldPersistToAuditLog()
        {
            ...
            var evt = new ApplicationApprovedEvent(applicationId, officerId);
        ...
        {
            // Act & Assert
            Assert.Throws<ArgumentNullException>(() => new ApplicationApprovedEventHandler(null!));
        }
    }
}
