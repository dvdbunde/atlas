...
> **Status:** Superseded specification. This original task describes the earlier confirmation-dialog approach. The authoritative revised specification is [`M12-012-revised.md`](M12-012-revised.md), which uses inline confirmation state instead of a modal dialog. This file is retained as historical implementation context.
