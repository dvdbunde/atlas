...
This directory describes the system architecture, deployment topology, observability model, and architectural decisions.

## Architecture Decision Records

- [Architecture Decision Records (ADRs)](../ADRs/README.md) — ADR-001 through ADR-024
